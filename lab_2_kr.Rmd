...
# setting the seed to make it so they aren't totally randomized, allows you to replicate better
set.seed(42)
...
#testing model predictions vs actual mass
